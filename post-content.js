...
window._wpGutenbergPost = {
	content: {
		raw: [
			...
			'<!-- wp:core/tinymce -->',
			'<p>A "core/tinymce" block using <strong>TinyMCE inlite</strong> theme.</p><ul><li>Double-click a word to see the inline menu</li><li>Right-click to see the context menu</li><li>Hit enter to see the insert menu</li></ul><table style="width: 100%;" data-mce-style="width: 100%;" class="mce-item-table"><tbody><tr><td>A table</td><td>cell r0c1</td></tr><tr><td>cell r1 c0</td><td>cell r1c1</td></tr></tbody></table><blockquote><p>A quote</p></blockquote><p>and some final text.</p>',
			'<!-- /wp:core/tinymce -->',
